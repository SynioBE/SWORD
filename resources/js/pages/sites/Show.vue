...
// All install steps — must match installPing() calls in install-site.blade.php
const ALL_STEPS = [
        ...
        >
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            />
                            <Loader2
                                v-else-if="site.current_step === step"
                            ...
                            <span
                                :class="{
                                    'font-medium': site.current_step === step,
                                }"
                            >
                                {{ step }}
                            </span>
            ...
            <template v-if="isInstalled">
                ...
                >
                    ...
                    >
                        <div
                            v-for="entry in site.install_log"
